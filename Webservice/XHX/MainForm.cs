...
namespace XHX
{
    public partial class MainForm : XtraForm
    {
        ...
        void CreateBizMenuList()
        {
            ...
            mainMenu.DropDownItems.Add(subMenu);
            subMenu = new ToolStripMenuItem("人员和硬件", null, new EventHandler(menu_Click)); subMenu.Tag = "AnswerRecheck";
            mainMenu.DropDownItems.Add(subMenu);
        ...
        void menu_Click(object sender, EventArgs e)
        {
            ...
            Assembly asmb = Assembly.Load("DSATUploadData");

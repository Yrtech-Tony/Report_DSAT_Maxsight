...
{
    public class BMRController : BaseController
    {
        // GET: BMR
        ...
        {
            string reportPath = HttpContext.Server.MapPath("~/ReportFiles/BMR/QuarterReport");//季度报告所在的文件路径
        ...
        {
            string reportPath = HttpContext.Server.MapPath("~/ReportFiles/BMR/DealerGuide");//指导手册所在的文件路径
        ...
        public ActionResult DownloadFiles(string areaCode, string groupCode, string shopCode, string year, string quarterormonth, string type)
        {
            try
            {
                string reportPath = HttpContext.Server.MapPath("~/ReportFiles/BMR/");
                ...
                if (!Directory.Exists(reportPath + @"TEMP\"))
                {
                    Directory.CreateDirectory(reportPath + @"TEMP\");
                }
